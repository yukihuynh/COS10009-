...
while col < x_cell_count:
    ...
    while row < y_cell_count:
        ...
        print(
            f"Cell x:{col}, y:{row} | "
            f"N:{'None' if cell.north is None else 'OK'} "
            f"S:{'None' if cell.south is None else 'OK'} "
            f"E:{'None' if cell.east is None else 'OK'} "
            f"W:{'None' if cell.west is None else 'OK'}"
        )
