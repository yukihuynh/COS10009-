...
class MyGUI:
    ...
    # The draw_planet method draws a circle with its center point
    # at x,y on the canvas. The radius parameter specifies the
    # circle's radius, and the color parameter specifies the
    # circle's fill color.
    ...
    # The draw_ringed_planet method draws a ringed planet.
